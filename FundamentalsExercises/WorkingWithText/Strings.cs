...
namespace FundamentalsExercises.WorkingWithText
{
    class Strings
    {
        /* 
           1- Write a program and ask the user to enter a few numbers separated by a hyphen.Work out
        ...
        public void Exercise3()
        {
            ...
            try
            {
                ...
                if (hour >= 0 && hour <= 23 && minute >= 0 && minute <= 59)
                    Console.WriteLine("Ok - Time is: " + input);
                else
                    Console.WriteLine("Invalid Time");
            }
            catch (Exception)
